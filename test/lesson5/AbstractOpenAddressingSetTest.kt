...
abstract class AbstractOpenAddressingSetTest {
    ...
    protected fun doIteratorTest() {
        ...
        controlSet.addAll(arrayOf("123nhbhaag", "nujsn71bhbs", "hagb7127bna", "1bhb2bh1bb", "aaa", "bahh2b1h", "test"))
        println("Control set: $controlSet")
        println("Control set: $controlSet")
        val openAddressingSet = create<String>(random.nextInt(6) + 4)
        assertFalse(
    ...
    protected fun doIteratorRemoveTest() {
        ...
        val controlSet = mutableSetOf<String>()
        controlSet.addAll(arrayOf("h234abgfh", "123587ba", "fgh1", "2", "ghabfed", "1b2abbbb3", "abba187bchf", "hab24"))
        println("Control set: $controlSet")
        val toRemove = "2"
        println("Initial set: $controlSet")
        val openAddressingSet = create<String>(random.nextInt(6) + 4)
