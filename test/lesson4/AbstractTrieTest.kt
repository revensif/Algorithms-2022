...
abstract class AbstractTrieTest {
    ...
    protected fun doIteratorTest() {
        ...
        val controlSet = sortedSetOf<String>()
        controlSet.addAll(arrayOf("abkjk", "asmdkmak", "anmsjasd", "kamnsjdnmaj", "a", "kansmgkm", "test"))
        println("Control set: $controlSet")
        val trieSet = create()
        assertFalse(
            trieSet.iterator().hasNext(),
    ...
    protected fun doIteratorRemoveTest() {
        ...
        val controlSet = sortedSetOf<String>()
        controlSet.addAll(arrayOf("abkjk", "bmloksjn", "anmsjasd", "kamnsjdnmaj", "a", "kansmgkm", "test", "lasqownj"))
        println("Control set: $controlSet")
        val toRemove = "test"
        println("Initial set: $controlSet")
        val trieSet = create()
